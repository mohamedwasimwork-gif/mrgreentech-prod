...
export const metadata: Metadata = {
  title: 'MR Greentech — Metal scrap trade, moved with intent',
  description:
    'A metal scrap trade house based in Chennai connecting South Indian industry to the world since 2014.',
};
